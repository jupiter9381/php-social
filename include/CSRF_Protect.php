...
class CSRF_Protect
{
	 ...
	 * @return boolean
	 */
	public function checkTokenValid($userToken)
	{
		return ($userToken === $this->readTokenFromStorage());
		/*if ($userToken === $this->readTokenFromStorage()) {
	...
	/**
	 * This is custom generate token
	 */
	public function ManualTokenGen()
	{
		$arr = array();
		$token = $this->getToken();
		$arr['name'] = $this->namespace;
		$arr['token'] = $token;
		return $arr;
	}
