...
if(isset($_POST['login']))
{
	...
	{
		$time=time();	
		$user_row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT id,isLocked,referral_id,name, mobile_number,setup_shop FROM users WHERE mobile_number='$cm' AND password='$password' AND user_roles = '$user_role'"));
